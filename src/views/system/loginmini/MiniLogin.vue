...
<script lang="ts" setup name="login-mini">
  ...
  import logoImg from '/@/assets/loginmini/icon/wia_logo.png';
  import adTextImg from '/@/assets/loginmini/icon/wia_logo.png';
  ...
  async function loginHandleClick() {
    if (unref(activeIndex) === 'accountLogin') {
      ...
      createMessage.warn('Ref error contact admin');
    }
  }
